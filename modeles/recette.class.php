...
class Recette
{
    ...
    /**
     * COnstruire un objet recette
     *
     * @param integer|null $id l'identifiant de la recette
     * @param string|null $nom nom de la recette
     * @param string|null $description
     * @param string|null $image
     * @param Categorie|null $categorie c'est la categorie de la recette : Entrée, Plat et Dessert
     ...
     *
     * @return integer|null id de la recette ou null si la recette n'existe pas
     */
